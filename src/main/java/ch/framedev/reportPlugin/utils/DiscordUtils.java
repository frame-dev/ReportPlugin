...
public class DiscordUtils {
    ...
    public static boolean sendReportToDiscord(ReportPlugin plugin, Report report) {
        ...
        description = description.replace("%ReportedPlayer%", report.getReportedPlayer())
                ...
                .replace("%AdditionalInfo%", report.getAdditionalInfo().isEmpty() ? "N/A" : report.getAdditionalInfo())
                .replace("%EvidenceUrl%", report.getEvidenceUrl().isEmpty() ? "N/A" : report.getEvidenceUrl())
